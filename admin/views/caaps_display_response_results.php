				...
				while ( $i < $total_products ) {
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
							<?php 
							if ( isset( $processed_responses[$i]['asin'] ) && ! empty( $processed_responses[$i]['asin'] )  ) {
								echo ( isset( $processed_responses[$i]['medimage'] ) && ( ! empty( $processed_responses[$i]['medimage'] )) )? '<div style="width:auto;height:160px;margin-bottom:15px;"><img src="'.$processed_responses[$i]['medimage'].'" alt="" style="height:160px;" /></div>' : '';
